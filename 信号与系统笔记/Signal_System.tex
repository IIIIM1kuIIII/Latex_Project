    ...
    \subsection{几个重要信号}
        \subsubsection{连续时间信号}
            \begin{enumerate}
                ...
                \begin{enumerate}
                    \item 当t=0时$Sa(0)=1$
                    \item 当$t=\pm \pi,...,\pm n\pi$时$Sa(t)=0$
                    \item Sa是一个偶函数,奇函数除奇函数为偶函数
                    \item 抽样函数的性质
                        \begin{equation}
                            ...
                            \item[(4)]总结：
                                \begin{tcolorbox}[colback=blue!5!white]
                                    \begin{enumerate}
                                        ...
                                        \item $x(t)\delta(t)=x(0)\delta(t)$
                                        \item $\displaystyle \delta(at)=\frac{1}{|a|}\delta(t)$
                                        \item $\displaystyle \delta(f(t))=\sum_{\text{所有}f(t_0)=0}^{max} \frac{1}{|f'(t_0)|}\delta(t-t_0)$
                                    \end{enumerate}
                                \end{tcolorbox}
            ...
            \begin{enumerate}
                ...
                \item 公式法求卷积的方法
                    \begin{enumerate}
                        \item 翻转、平移、相乘、求和
                        \begin{equation}
                            x[n]\ast h[n]=\sum_{k=-\infty}^{\infty} x[k]h[-(k-n)]
                        \end{equation}
                        \item $x[n]$、$h[n]$都可以翻转，但是翻转哪个平移哪个
                    \end{enumerate}
            \end{enumerate}
        \end{tcolorbox}
    \subsection{连续LTI系统卷积}
        \begin{equation}
            \int_{-\infty}^{\infty} x(\tau)h(t-\tau) d\tau
        \end{equation}
        若$\delta(t)\xrightarrow{LTI}h(t)$则$x(t)\xrightarrow{LTI}y(t)=\int_{-\infty}^{\infty} x(\tau)h(t-\tau) d\tau$
\end{document}